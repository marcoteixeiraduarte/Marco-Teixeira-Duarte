# Suche erweitert — sie müssen da sein

**Auftraggeber:** Die Jahre und, zur Not, die Ortschaften weitermachen.
Die Einträge sind da. Ein leeres erstes Fenster heißt nicht „gibt es
nicht“. Linien trotzdem nicht mischen.

Marker bleiben: **João Teixeira × Maria José dos Santos**, Eltern
**Francisco José dos Santos × Maria Thereza**; **Manuel d'Matta ×
Joaquina Reis**; **Luiz Guiomar** Bemposta; **Delfina Maria**;
...
| Pfarrei | Code | tombo |
| --- | --- | --- |
| Torre de Vale de Todos | `PANS08` | [ans08](https://tombo.pt/f/ans08) |
| Lagarteira | `PANS05` | [ans05](https://tombo.pt/f/ans05) |
| Ansião | `PANS02` | [ans02](https://tombo.pt/f/ans02) |
| Chão de Couce | `PANS04` | [ans04](https://tombo.pt/f/ans04) |
| Cumeeira (Penela) | `PNL01` | [pnl01](https://tombo.pt/f/pnl01) |
| Avelar | `PANS03` | [ans03](https://tombo.pt/f/ans03) |
| Alvorge | `PANS01` | [ans01](https://tombo.pt/f/ans01) |

### Ring 2 — zur Not, gleicher Kreis Ansião

| Pfarrei | Code | Rolle |
| --- | --- | --- |
| Pousaflores | `PANS06` | äußerer Nachbar |
| Santiago da Guarda | `PANS07` | äußerer Nachbar; Namensvetter Carrasqueiras nicht hängen |

### Ring 3 — zur Not, Penela und danach

Cumeeira reicht nicht: **Santa Eufémia**, Espinhal, Podentes,
Rabaçal (`PNL…` am AUC). João ist natürlich Cumeeira/Penela; eine
Heirat in einer anderen Penela-Pfarrei ist möglich.

Erst wenn 1–3 leer: Figueiró dos Vinhos. Nicht Gondomar, nicht São
Cosme, nicht andere Namensvettern außerhalb.

## Fenster, erweitert

| Ereignis | Alt | Jetzt | Erstes Buch |
| --- | --- | --- | --- |
...
| Joaquina Ramalha * **15.06.1873** | Blatt | Geburt **haben wir.** Taufe nur **um den 15.06.1873**. Torre 1873 ohne Eintrag. Alvorge Juni 1873 (m0170–m0173): **kein passender Eintrag gefunden** — kein Ortsausschluss. Auftraggeber Ateanha = **Kandidat**. Eltern-Heirat Feb. 1838 Torre (21. oder 22.; Identität Kandidat). Maria selbst nicht Torre Sept. 1842–1845. **Angelica * ~28.03.1815 / ~ 06.04.1815** Castello gefunden (Manoel Leal × Thereza). Ältere Ramalho Lagarteira 1778–1816 ohne isoliertes Paar | [ramalha-ateanha-1873](linie-torre/ramalha-ateanha-1873.md) · [angelica-maria](../akten/matta/angelica-maria/README.md) |
...
## Lokal schon da, noch durchforsten

| Ordner | Inhalt |
| --- | --- |
| `suche/ansiao-maria-jose/baptismos-1878-1883/` | Maria José, Marker Santos × Thereza |
| `suche/ansiao-maria-jose/baptismos-1884-1889/` | dasselbe |
| `suche/ansiao-maria-jose/casamentos-1880-1899/` | João × Maria José, falls Ansião; Manuel × Joaquina war **Torre 1896**, nicht hier |
| `suche/ansiao-maria-jose/casamentos-1900-1909/` | João × Maria José |
| `suche/alvorge-taufen-1822-1852/` | avô-Paar Antonio × Joaquina (Luiz als Sohn); Roza Maria. Luiz × Delfina nicht noch einmal |
| `suche/torre-taufen-rohbande/` | Kinder Luiz × Delfina (António ~1866–70); nicht Luiz selbst (der ist Alvorge) |
| `suche/torre-heiraten-rohbande/` | Rohbände 1896–1898 lokal (nicht Git); Match 1896 in `archiv/matta/` |

Diese Rohbände nicht in Git, bis ein Treffer festliegt. Treffer dann
wie bisher: `archiv/<name>/` plus `akten/<name>/`.

## Gefunden, weil die Jahre weitergingen

Zivil 1912 schrieb **26.08.1897**. Band 1897 (`PANS08/002/0039`, 11
Bilder, zehn Heiraten) hat das Paar **nicht**. Band **1896**
(`PANS08/002/0038`) N.º 2: **21. August 1896**, Manuel Matta ×
...
**Sebastião * 7.05.1871**, **primeiro deste nome** von José dos Reis ×
Maria Ramalha, Pragoza — erster dieses Namens, nicht Erstgeburt. Neto
paterno Manuel Pedro dos Reis × Joaquina Maria — dieselben Eltern wie
Manoel Pedro dos Reis. Die zwei Häuser sind **Brüderhäuser**.
