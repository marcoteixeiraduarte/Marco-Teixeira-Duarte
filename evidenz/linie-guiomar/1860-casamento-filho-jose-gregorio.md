...
linke Seite, erster Akt (N.º 1, 16. Februar).

- Archiv: `PT/ADLRA/PRQ/PANS08/002/0004`
- DigitArq: `05068c6b3e91459baf7a6f2993b4a6c0`
- Versioniert: `evidenz/scans/torre/PT-ADLRA-PRQ-PANS08-002-0004_m0003.jpg`
- Arbeitskopie: `archiv/guiomar/1860-casamento-filho-jose-gregorio-PANS08-002-0004_m0003.jpg`

## Was feststeht

| Feld | Wert | Gewissheit |
|---|---|---|
| Datum | 16. Februar 1860 | sicher |
...
Lesung am DigitArq-Scan (1500 px, blasse Tinte):

> comparecerão os noivos [José Gregorio] e [Maria Jozepha]

Das ist **wahrscheinlich**, nicht fest. FamilySearch (Katalog 1990465 /
Torre-Bände) hat schärfere Seiten; von dieser Maschine **403**.
...
**Luiz Guiomar** steht in den gelesenen Zeilen **nicht**.
Das ist **nicht** Luiz × Delfina.

Delfina (* vor 1874, Taufe offen) hat damit mindestens ein
geschwisterliches Ereignis 1860. Ob sie die 29-Jährige selbst ist
(dann * um 1831, João mit ~43 Jahren), bleibt **offen**.

## Was dieser Akt nicht ist

- Keine Heirat Luiz × Delfina.
- Nicht mit Roza/Reis (Vale Paio / Aljazede) vermischen.
- 1865 `m0003` rechts: Unterschriften **Joaquim Gato** / **Manoel Reis
  Gato** — andere Linie, dieselbe Pfarrei.
