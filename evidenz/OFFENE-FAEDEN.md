...
Lebende Liste. Methode: [`SUCHMODELL.md`](SUCHMODELL.md).
Nach Fortschritt diese Datei und ggf. [`ERKENNTNISSE.md`](../ERKENNTNISSE.md) aktualisieren.

## Schließen (Material liegt schon da)

| ID | Faden | Nächster Schritt | Status | Protokoll |
| --- | --- | --- | --- | --- |
...
| N1 | Narciza Geburt `mez passado` | Taufe 1856 nochmals lesen | Scan da | offen | [`narciza.md`](linie-torre/narciza.md) |

## Verbinden (erst nach sicher/wahrscheinlich)

| ID | Verbindung | Bedingung |
| --- | --- | --- |
| V1 | Roza → G4 Reis 1851 | T1 sicher |
| V2 | Manoel Pedro → G4 Reis 1851 | T2 sicher |
| V3 | Joaquim×Florencia im Baum als Rozas Eltern | T1 (+ ggf. T3) |
| V4 | José Freire Bicho an Margarida 1922 | D1 gelesen |
| V5 | Duarte-G3 eigene Akten | D2 |

## Bewusst später / nicht jetzt
