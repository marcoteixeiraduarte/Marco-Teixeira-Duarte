...
| | |
| --- | --- |
| Quellenname | Maria Helena (Taufe der Tochter; Contente = Vater Jozé Contente) |
| Rolle | 4.º avó; Valle do Pião |
| * | Blatt ca. 1852 · Vale do Pião — Taufe 1850–54 nicht isoliert |
| † | offen |
| Eltern / genannt mit | Jozé Contente × Helena Maria (genannt 1882) |
| Gewissheit | sicher als Mutter 1882; eigene Taufe offen |

Kein eigener Akt. Blatt hängt Contente an sie — derselbe Fehlertyp wie Narcisa Rodrigues Gato.
